                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">All Board</h3>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <span class="action-btn">
                                                            <a href="{{ route('admin.board.edit', $item->id) }}"
                                                          ...
                                                          <i class="fa fa-eye"></i>
                                                            ...
                                                            {{-- <a href="{{ route('admin.board.delete',$item->id) }}" class=" btn-delete deleteButton" >
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form
                                                                        action="{{ route('admin.board.update', $item->id) }}"
