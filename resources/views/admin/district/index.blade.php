                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="{{ route('admin.district.create') }}" class="btn btn_new_info float-right"
                                        ...
                                        @if ($districts->isNotEmpty())
                                            @foreach ($districts as $key => $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($item->status == 1)
                                                            <a href="{{ route('admin.district.statusChange', $item->id) }}"><span
                                                    ...
                                                    <td class="text-center">
                                                        <span class="action-btn">
                                                            <a href="{{ route('admin.district.edit', $item->id) }}"
                                                          ...
                                                          <i class="fa fa-eye"></i>
                                                            ...
                                                            {{-- <a href="{{ route('admin.district.delete', $item->id) }}"
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form
                                                                        action="{{ route('admin.district.update', $item->id) }}"
