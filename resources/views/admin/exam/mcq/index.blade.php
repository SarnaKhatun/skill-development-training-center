                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="{{ route('admin.mcq-exams.create') }}" class="btn btn_new_info float-right">
                            ...
                            <div class="card-body showtable">
                                @include('admin.exam.mcq.index_table')
                            </div>
                            <!-- /.card-body -->
                        </div>
                    </div>
...
@push('js')
    ...
    <script>
        function updateDataTable() {
            ...
            const url = "{{ route('admin.mcq-exams.index') }}?" + $.param(params);
