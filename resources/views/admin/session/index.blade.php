                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Dashsession</a></li>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="{{ route('admin.session.create') }}" class="btn btn_new_info float-right"
                                            ...
                                            @foreach ($sessions as $key => $item)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        @if ($item->status == 1)
                                                            <a href="{{ route('admin.session.statusChange', $item->id) }}"><span
                                                    ...
                                                    <td class="text-center">
                                                        <span class="action-btn">
                                                            <a href="{{ route('admin.session.edit', $item->id) }}"
                                                                ...
                                                                <div class="modal-dialog" role="document">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form
                                                                                action="{{ route('admin.session.update', $item->id) }}"
                                                                                method="post"
                                                          ...
                                                          <i class="fa fa-eye"></i>
                                                            ...
                                                            {{-- <a href="{{ route('admin.session.delete',$item->id) }}" class=" btn-delete deleteButton" >
