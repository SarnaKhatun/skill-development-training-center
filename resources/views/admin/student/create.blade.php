                                                    ...
                                                    <div class="tab-content" id="myTabContent">
                                                        <div class="tab-pane fade show active" id="personal" role="tabpanel"
                                                            ...
                                                            <div class="row">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="">Gender<small
                                                                            ...
                                                                            <div class="form-check">
                                                                                <input class="form-check-input" type="radio" name="gender" value="Male" name="flexRadioDefault" id="flexRadioDefault1">
                                                                                <label class="form-check-label" for="flexRadioDefault1">
                                                                                  Male
                                                                                </label>
                                                                              </div>
                                                                              <div class="form-check">
                                                                                <input class="form-check-input" type="radio" name="gender" value="Female" name="flexRadioDefault" id="flexRadioDefault2">
                                                                ...
                                                                <div class="col-6">
                                                                    <div class="form-group">
                                                                        <label for="exampleInputFile">Image <span style="font-size:14px;color:red; ">(Dimensions:width=108px,height=137px)</span></label>
                                                                        <div class="input-group">
                                                                            <div class="custom-file">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" required name="present_address" value="{{ old('present_address') }}" class="form-control custom_form_control">
                                                                ...
                                                                <div class="col-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" required name="premanent_address" value="{{ old('premanent_address') }}" class="form-control custom_form_control">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" required name="roll" oninput="this.value=this.value.replace(/[^0-9]/g,'')" value="{{ old('roll') }}" class="form-control custom_form_control">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" required oninput="this.value=this.value.replace(/[^0-9]/g,'')" name="registration" value="{{ old('registration') }}" class="form-control custom_form_control">
