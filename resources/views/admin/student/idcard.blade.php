    ...
    <div id="content2" class="cert">
        ...
        <div class="header_bottom" style="position: absolute;top:170px;left:70px">
            <table style="width: 100%">
                <tr>
                    <td style="width:100px"><strong>SL No. </strong>{{$student->id}}</td>
                    <td style="text-align: center" width:500px>
                        ...
                        <button
                            style="background: #B4AE14;color:white;border-radius:10px;padding:5px 20px;font-weight:700">Id
                            Card</button>
                    </td>
                    <td>
        ...
        <div class="student_info" style="position: absolute;top:320px;left:70px;">
            <table style="border: 1px solid black;
                ...
                <tr>
                    ...
                    <th colspan="3">{{ $student->name_en }}</th>
                </tr>
                <tr>
                    <td>Father's Name </td>
                    <th colspan="3">{{ $student->fathers_name }}</th>
                </tr>
                <tr>
                    <td>Mother's Name </td>
                    <th colspan="3">{{ $student->mothers_name }}</th>
                </tr>
                <tr>
                    <td>Centre Code</td>
                    <th colspan="3">{{ $student->branch->center_code }}</th>
                </tr>
                <tr>
                    <td>Centre Name</td>
                    <th colspan="3">{{ $student->branch->institute_name_en }}</th>
                </tr>
                <tr>
                    <td>Course Name </td>
                    <th colspan="3">{{ $student->course->name }}</th>
                </tr>
                <tr>
                    <td>Session</td>
                    <th colspan="3">{{ \Carbon\Carbon::parse($student->session_start)->format('j F ') }}  -  {{ \Carbon\Carbon::parse($student->session_end)->format('j F ') }}</th>
                </tr>
                <tr>
                    <td>Roll No</td>
                    <th>{{ $student->student_roll }}</th>
                    <td>Registration No</td>
                    <th>{{ $student->student_registration_no }}</th>
                </tr>
            </table>
        </div>
